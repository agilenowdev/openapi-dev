...
namespace Agile.Now.ApiOrganizations.Model
{
    ...
    public partial class LocationUpdateData : IValidatableObject
    {
        ...
        public LocationUpdateData(string externalId = default(string), string name = default(string), EnumCountry? countryId = default(EnumCountry?), EnumTimezone? timezoneId = default(EnumTimezone?), EnumCurrency? currencyId = default(EnumCurrency?), bool isActive = false)
        {
