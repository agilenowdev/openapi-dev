...
namespace Agile.Now.ApiOrganizations.Api
{
    ...
    public partial class DepartmentsApi : IDepartmentsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Users</returns>
        public Agile.Now.ApiOrganizations.Client.ApiResponse<Users> ListDepartmentUsersWithHttpInfo(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), string? pageSize = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
