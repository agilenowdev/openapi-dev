...
using Agile.Now.OrganizationsApi.Client.Auth;
using Agile.Now.OrganizationsApi.Model;

namespace Agile.Now.OrganizationsApi.Api
{
    ...
    public interface ILocationsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Agile.Now.OrganizationsApi.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Agile.Now.OrganizationsApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Agile.Now.OrganizationsApi.Client.Configuration.MergeConfigurations(
                Agile.Now.OrganizationsApi.Client.GlobalConfiguration.Instance,
                new Agile.Now.OrganizationsApi.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Agile.Now.OrganizationsApi.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Agile.Now.OrganizationsApi.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = Agile.Now.OrganizationsApi.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public LocationsApi(Agile.Now.OrganizationsApi.Client.Configuration configuration)
        {
            ...
            this.Client = new Agile.Now.OrganizationsApi.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Agile.Now.OrganizationsApi.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Agile.Now.OrganizationsApi.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public LocationsApi(Agile.Now.OrganizationsApi.Client.ISynchronousClient client, Agile.Now.OrganizationsApi.Client.IAsynchronousClient asyncClient, Agile.Now.OrganizationsApi.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Agile.Now.OrganizationsApi.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Agile.Now.OrganizationsApi.Client.ISynchronousClient Client { get; set; }
        ...
        public Agile.Now.OrganizationsApi.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Agile.Now.OrganizationsApi.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = CreateLocationWithHttpInfo(locationData);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Location</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Location> CreateLocationWithHttpInfo(LocationData locationData, int operationIndex = 0)
        {
            // verify the required parameter 'locationData' is set
            if (locationData == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'locationData' when calling LocationsApi->CreateLocation");
            }

            Agile.Now.OrganizationsApi.Client.RequestOptions localVarRequestOptions = new Agile.Now.OrganizationsApi.Client.RequestOptions();
            ...
            var localVarContentType = Agile.Now.OrganizationsApi.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);
            }

            var localVarAccept = Agile.Now.OrganizationsApi.Client.ClientUtils.SelectHeaderAccept(_accepts);
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = await CreateLocationWithHttpInfoAsync(locationData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Location)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<Location>> CreateLocationWithHttpInfoAsync(LocationData locationData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'locationData' is set
            if (locationData == null)
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = DeleteLocationWithHttpInfo(id, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Location</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Location> DeleteLocationWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'id' when calling LocationsApi->DeleteLocation");
            }
            ...
            localVarRequestOptions.PathParameters.Add("Id", Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToString(id)); // path parameter
            if (name != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "Name", name));
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = await DeleteLocationWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Location)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<Location>> DeleteLocationWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<User> localVarResponse = DeleteLocationUserWithHttpInfo(id, subId, name, subName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of User</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<User> DeleteLocationUserWithHttpInfo(string id, string subId, string? name = default(string?), string? subName = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'id' when calling LocationsApi->DeleteLocationUser");
            }

            // verify the required parameter 'subId' is set
            if (subId == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'subId' when calling LocationsApi->DeleteLocationUser");
            }
            ...
            localVarRequestOptions.PathParameters.Add("Id", Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("SubId", Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToString(subId)); // path parameter
            if (name != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "Name", name));
            }
            if (subName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "SubName", subName));
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<User> localVarResponse = await DeleteLocationUserWithHttpInfoAsync(id, subId, name, subName, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (User)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<User>> DeleteLocationUserWithHttpInfoAsync(string id, string subId, string? name = default(string?), string? subName = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = GetLocationWithHttpInfo(id, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Location</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Location> GetLocationWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'id' when calling LocationsApi->GetLocation");
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = await GetLocationWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Location)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<Location>> GetLocationWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Users> localVarResponse = ListLocationUsersWithHttpInfo(id, name, fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Users</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Users> ListLocationUsersWithHttpInfo(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), string? pageSize = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'id' when calling LocationsApi->ListLocationUsers");
            }
            ...
            if (fields != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "Fields", fields));
            }
            if (filters != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "Filters", filters));
            }
            if (orders != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "Orders", orders));
            }
            if (currentPage != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "CurrentPage", currentPage));
            }
            if (pageSize != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "PageSize", pageSize));
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Users> localVarResponse = await ListLocationUsersWithHttpInfoAsync(id, name, fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Users)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<Users>> ListLocationUsersWithHttpInfoAsync(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), string? pageSize = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Locations> localVarResponse = ListLocationsWithHttpInfo(fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Locations</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Locations> ListLocationsWithHttpInfo(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            Agile.Now.OrganizationsApi.Client.RequestOptions localVarRequestOptions = new Agile.Now.OrganizationsApi.Client.RequestOptions();
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Locations> localVarResponse = await ListLocationsWithHttpInfoAsync(fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Locations)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<Locations>> ListLocationsWithHttpInfoAsync(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<User> localVarResponse = PatchLocationUsersWithHttpInfo(id, usersData, name, deleteNotExists);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of User</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<User> PatchLocationUsersWithHttpInfo(string id, UsersData usersData, string? name = default(string?), string? deleteNotExists = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'id' when calling LocationsApi->PatchLocationUsers");
            }

            // verify the required parameter 'usersData' is set
            if (usersData == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'usersData' when calling LocationsApi->PatchLocationUsers");
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.OrganizationsApi.Client.ClientUtils.ParameterToMultiMap("", "DeleteNotExists", deleteNotExists));
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<User> localVarResponse = await PatchLocationUsersWithHttpInfoAsync(id, usersData, name, deleteNotExists, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Locations> localVarResponse = PatchLocationsWithHttpInfo(locationsData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Locations</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Locations> PatchLocationsWithHttpInfo(LocationsData locationsData, int operationIndex = 0)
        {
            // verify the required parameter 'locationsData' is set
            if (locationsData == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'locationsData' when calling LocationsApi->PatchLocations");
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Locations> localVarResponse = await PatchLocationsWithHttpInfoAsync(locationsData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Locations)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<Locations>> PatchLocationsWithHttpInfoAsync(LocationsData locationsData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'locationsData' is set
            if (locationsData == null)
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = UpdateLocationWithHttpInfo(id, locationData, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Location</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Location> UpdateLocationWithHttpInfo(string id, LocationData locationData, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'id' when calling LocationsApi->UpdateLocation");
            }

            // verify the required parameter 'locationData' is set
            if (locationData == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'locationData' when calling LocationsApi->UpdateLocation");
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = await UpdateLocationWithHttpInfoAsync(id, locationData, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = UpsertLocationWithHttpInfo(locationData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Location</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<Location> UpsertLocationWithHttpInfo(LocationData locationData, int operationIndex = 0)
        {
            // verify the required parameter 'locationData' is set
            if (locationData == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'locationData' when calling LocationsApi->UpsertLocation");
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<Location> localVarResponse = await UpsertLocationWithHttpInfoAsync(locationData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Location)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<Location>> UpsertLocationWithHttpInfoAsync(LocationData locationData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'locationData' is set
            if (locationData == null)
            {
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<User> localVarResponse = UpsertLocationUserWithHttpInfo(id, userData, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of User</returns>
        public Agile.Now.OrganizationsApi.Client.ApiResponse<User> UpsertLocationUserWithHttpInfo(string id, UserData userData, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'id' when calling LocationsApi->UpsertLocationUser");
            }

            // verify the required parameter 'userData' is set
            if (userData == null)
            {
                throw new Agile.Now.OrganizationsApi.Client.ApiException(400, "Missing required parameter 'userData' when calling LocationsApi->UpsertLocationUser");
            }
        ...
        {
            Agile.Now.OrganizationsApi.Client.ApiResponse<User> localVarResponse = await UpsertLocationUserWithHttpInfoAsync(id, userData, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (User)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.OrganizationsApi.Client.ApiResponse<User>> UpsertLocationUserWithHttpInfoAsync(string id, UserData userData, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
