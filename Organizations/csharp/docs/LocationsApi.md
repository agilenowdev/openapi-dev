# Agile.Now.OrganizationsApi.Api.LocationsApi
...
# **CreateLocation**
> Location CreateLocation (LocationData locationData)
...
namespace Example
{
    public class CreateLocationExample
    {
        public static void Main()
        {
            ...
            var locationData = new LocationData(); // LocationData | `Location` information to insert.  The input parameter must be used in the `LocationData` record structure inside the `FieldType` parameter in the foreign key fields.
...
try
{
    ApiResponse<Location> response = apiInstance.CreateLocationWithHttpInfo(locationData);
...
{
    Debug.Print("Exception when calling LocationsApi.CreateLocationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling LocationsApi.DeleteLocationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the DeleteLocationUserWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling LocationsApi.DeleteLocationUserWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **ListLocationUsers**
> Users ListLocationUsers (string id, string? name = null, string? fields = null, string? filters = null, string? orders = null, int? currentPage = null, string? pageSize = null)
...
{
    Debug.Print("Exception when calling LocationsApi.ListLocationUsersWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling LocationsApi.PatchLocationUsersWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **PatchLocations**
> Locations PatchLocations (LocationsData locationsData)
...
namespace Example
{
    public class PatchLocationsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling LocationsApi.PatchLocations: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the PatchLocationsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<Locations> response = apiInstance.PatchLocationsWithHttpInfo(locationsData);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling LocationsApi.PatchLocationsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **UpdateLocation**
> Location UpdateLocation (string id, LocationData locationData, string? name = null)
...
namespace Example
{
    public class UpdateLocationExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new LocationsApi(config);
            var id = "id_example";  // string | The identifier of the Location record. The parameter is part of the url address and some special characters are forbidden.  You can extract any string to a base64 string. E.g email address name@domain.com value is base64|bmFtZUBkb21haW4uY29t
            var locationData = new LocationData(); // LocationData | Location information to update.  The input parameter must be used in the `LocationData` record structure inside the `FieldType` parameter in the foreign key fields.
            var name = "name_example";  // string? | The name of the database field. If empty, the entity `Id` field is used.  Example:  ``` Name,ExternalId ``` (optional) 
...
try
{
    ApiResponse<Location> response = apiInstance.UpdateLocationWithHttpInfo(id, locationData, name);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling LocationsApi.UpdateLocationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling LocationsApi.UpsertLocationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling LocationsApi.UpsertLocationUserWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
