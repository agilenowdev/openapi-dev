...
using Agile.Now.AccountsApi.Client.Auth;
using Agile.Now.AccountsApi.Model;

namespace Agile.Now.AccountsApi.Api
{
    ...
    public interface IAccountsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Agile.Now.AccountsApi.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Agile.Now.AccountsApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Agile.Now.AccountsApi.Client.Configuration.MergeConfigurations(
                Agile.Now.AccountsApi.Client.GlobalConfiguration.Instance,
                new Agile.Now.AccountsApi.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Agile.Now.AccountsApi.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Agile.Now.AccountsApi.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = Agile.Now.AccountsApi.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public AccountsApi(Agile.Now.AccountsApi.Client.Configuration configuration)
        {
            ...
            this.Client = new Agile.Now.AccountsApi.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Agile.Now.AccountsApi.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Agile.Now.AccountsApi.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public AccountsApi(Agile.Now.AccountsApi.Client.ISynchronousClient client, Agile.Now.AccountsApi.Client.IAsynchronousClient asyncClient, Agile.Now.AccountsApi.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Agile.Now.AccountsApi.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Agile.Now.AccountsApi.Client.ISynchronousClient Client { get; set; }
        ...
        public Agile.Now.AccountsApi.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Agile.Now.AccountsApi.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = CreateAccountWithHttpInfo(accountData);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Account> CreateAccountWithHttpInfo(AccountData accountData, int operationIndex = 0)
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'accountData' when calling AccountsApi->CreateAccount");
            }

            Agile.Now.AccountsApi.Client.RequestOptions localVarRequestOptions = new Agile.Now.AccountsApi.Client.RequestOptions();
            ...
            var localVarContentType = Agile.Now.AccountsApi.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);
            }

            var localVarAccept = Agile.Now.AccountsApi.Client.ClientUtils.SelectHeaderAccept(_accepts);
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = await CreateAccountWithHttpInfoAsync(accountData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Account>> CreateAccountWithHttpInfoAsync(AccountData accountData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = DeleteAccountWithHttpInfo(id, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Account> DeleteAccountWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->DeleteAccount");
            }
            ...
            localVarRequestOptions.PathParameters.Add("Id", Agile.Now.AccountsApi.Client.ClientUtils.ParameterToString(id)); // path parameter
            if (name != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "Name", name));
            }
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = await DeleteAccountWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Account>> DeleteAccountWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Tenant> localVarResponse = DeleteAccountTenantWithHttpInfo(id, subId, name, subName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenant</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Tenant> DeleteAccountTenantWithHttpInfo(string id, string subId, string? name = default(string?), string? subName = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->DeleteAccountTenant");
            }

            // verify the required parameter 'subId' is set
            if (subId == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'subId' when calling AccountsApi->DeleteAccountTenant");
            }
            ...
            localVarRequestOptions.PathParameters.Add("Id", Agile.Now.AccountsApi.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("SubId", Agile.Now.AccountsApi.Client.ClientUtils.ParameterToString(subId)); // path parameter
            if (name != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "Name", name));
            }
            if (subName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "SubName", subName));
            }
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Tenant> localVarResponse = await DeleteAccountTenantWithHttpInfoAsync(id, subId, name, subName, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenant)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Tenant>> DeleteAccountTenantWithHttpInfoAsync(string id, string subId, string? name = default(string?), string? subName = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = GetAccountWithHttpInfo(id, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Account> GetAccountWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->GetAccount");
            }
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = await GetAccountWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Account>> GetAccountWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Tenants> localVarResponse = ListAccountTenantsWithHttpInfo(id, name, fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenants</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Tenants> ListAccountTenantsWithHttpInfo(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), string? pageSize = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->ListAccountTenants");
            }
            ...
            if (fields != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "Fields", fields));
            }
            if (filters != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "Filters", filters));
            }
            if (orders != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "Orders", orders));
            }
            if (currentPage != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "CurrentPage", currentPage));
            }
            if (pageSize != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.AccountsApi.Client.ClientUtils.ParameterToMultiMap("", "PageSize", pageSize));
            }
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Tenants> localVarResponse = await ListAccountTenantsWithHttpInfoAsync(id, name, fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenants)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Tenants>> ListAccountTenantsWithHttpInfoAsync(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), string? pageSize = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Accounts> localVarResponse = ListAccountsWithHttpInfo(fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Accounts</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Accounts> ListAccountsWithHttpInfo(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            Agile.Now.AccountsApi.Client.RequestOptions localVarRequestOptions = new Agile.Now.AccountsApi.Client.RequestOptions();
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Accounts> localVarResponse = await ListAccountsWithHttpInfoAsync(fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Accounts)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Accounts>> ListAccountsWithHttpInfoAsync(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = UpdateAccountWithHttpInfo(id, accountData, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Account> UpdateAccountWithHttpInfo(string id, AccountData accountData, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->UpdateAccount");
            }

            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'accountData' when calling AccountsApi->UpdateAccount");
            }
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = await UpdateAccountWithHttpInfoAsync(id, accountData, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Account>> UpdateAccountWithHttpInfoAsync(string id, AccountData accountData, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = UpsertAccountWithHttpInfo(accountData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Account> UpsertAccountWithHttpInfo(AccountData accountData, int operationIndex = 0)
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'accountData' when calling AccountsApi->UpsertAccount");
            }
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Account> localVarResponse = await UpsertAccountWithHttpInfoAsync(accountData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccountsApi.Client.ApiResponse<Account>> UpsertAccountWithHttpInfoAsync(AccountData accountData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Tenant> localVarResponse = UpsertAccountTenantWithHttpInfo(id, tenantData, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenant</returns>
        public Agile.Now.AccountsApi.Client.ApiResponse<Tenant> UpsertAccountTenantWithHttpInfo(string id, TenantData tenantData, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->UpsertAccountTenant");
            }

            // verify the required parameter 'tenantData' is set
            if (tenantData == null)
            {
                throw new Agile.Now.AccountsApi.Client.ApiException(400, "Missing required parameter 'tenantData' when calling AccountsApi->UpsertAccountTenant");
            }
        ...
        {
            Agile.Now.AccountsApi.Client.ApiResponse<Tenant> localVarResponse = await UpsertAccountTenantWithHttpInfoAsync(id, tenantData, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
