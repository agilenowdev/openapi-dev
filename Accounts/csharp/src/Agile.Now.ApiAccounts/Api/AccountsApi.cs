...
namespace Agile.Now.ApiAccounts.Api
{
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Pictures> localVarResponse = ListAccountPicturesWithHttpInfo(id, name, fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Pictures</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Pictures> ListAccountPicturesWithHttpInfo(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->ListAccountPictures");
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Pictures> localVarResponse = await ListAccountPicturesWithHttpInfoAsync(id, name, fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Pictures)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Pictures>> ListAccountPicturesWithHttpInfoAsync(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
