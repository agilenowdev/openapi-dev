...
using Agile.Now.ApiAccounts.Client.Auth;
using Agile.Now.ApiAccounts.Model;

namespace Agile.Now.ApiAccounts.Api
{
    ...
    public interface IAccountsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Agile.Now.ApiAccounts.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <param name="subName">The name of the database field. If empty, the entity &#x60;AccountId&#x60; field is used.  Example:  &#x60;&#x60;&#x60; AccountId.Username, AccountId.ExternalId &#x60;&#x60;&#x60; (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
    ...
    {
        private Agile.Now.ApiAccounts.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Agile.Now.ApiAccounts.Client.Configuration.MergeConfigurations(
                Agile.Now.ApiAccounts.Client.GlobalConfiguration.Instance,
                new Agile.Now.ApiAccounts.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Agile.Now.ApiAccounts.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Agile.Now.ApiAccounts.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = Agile.Now.ApiAccounts.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public AccountsApi(Agile.Now.ApiAccounts.Client.Configuration configuration)
        {
            ...
            this.Client = new Agile.Now.ApiAccounts.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Agile.Now.ApiAccounts.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Agile.Now.ApiAccounts.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public AccountsApi(Agile.Now.ApiAccounts.Client.ISynchronousClient client, Agile.Now.ApiAccounts.Client.IAsynchronousClient asyncClient, Agile.Now.ApiAccounts.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Agile.Now.ApiAccounts.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Agile.Now.ApiAccounts.Client.ISynchronousClient Client { get; set; }
        ...
        public Agile.Now.ApiAccounts.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Agile.Now.ApiAccounts.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = CreateAccountWithHttpInfo(accountData);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Account> CreateAccountWithHttpInfo(AccountData accountData, int operationIndex = 0)
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'accountData' when calling AccountsApi->CreateAccount");
            }
            ...
            var localVarContentType = Agile.Now.ApiAccounts.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);
            }

            var localVarAccept = Agile.Now.ApiAccounts.Client.ClientUtils.SelectHeaderAccept(_accepts);
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = await CreateAccountWithHttpInfoAsync(accountData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Account>> CreateAccountWithHttpInfoAsync(AccountData accountData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = DeleteAccountWithHttpInfo(id, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Account> DeleteAccountWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->DeleteAccount");
            }
            ...
            localVarRequestOptions.PathParameters.Add("Id", Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToString(id)); // path parameter
            if (name != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "Name", name));
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = await DeleteAccountWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Account>> DeleteAccountWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Picture> localVarResponse = DeleteAccountPictureWithHttpInfo(id, subId, name, subName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Picture</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Picture> DeleteAccountPictureWithHttpInfo(string id, string subId, string? name = default(string?), string? subName = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->DeleteAccountPicture");
            }

            // verify the required parameter 'subId' is set
            if (subId == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'subId' when calling AccountsApi->DeleteAccountPicture");
            }
            ...
            localVarRequestOptions.PathParameters.Add("Id", Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("SubId", Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToString(subId)); // path parameter
            if (name != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "Name", name));
            }
            if (subName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "SubName", subName));
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Picture> localVarResponse = await DeleteAccountPictureWithHttpInfoAsync(id, subId, name, subName, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public Agile.Now.ApiAccounts.Client.ApiResponse<Tenant> DeleteAccountTenantWithHttpInfo(string id, string subId, string? name = default(string?), string? subName = default(string?), int operationIndex = 0)
        {
            ...
            if (id == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->DeleteAccountTenant");
            }

            // verify the required parameter 'subId' is set
            if (subId == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'subId' when calling AccountsApi->DeleteAccountTenant");
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = GetAccountWithHttpInfo(id, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Account> GetAccountWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->GetAccount");
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = await GetAccountWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Account>> GetAccountWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Tenants> localVarResponse = ListAccountTenantsWithHttpInfo(id, name, fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenants</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Tenants> ListAccountTenantsWithHttpInfo(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            if (fields != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "Fields", fields));
            }
            if (filters != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "Filters", filters));
            }
            if (orders != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "Orders", orders));
            }
            if (currentPage != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "CurrentPage", currentPage));
            }
            if (pageSize != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agile.Now.ApiAccounts.Client.ClientUtils.ParameterToMultiMap("", "PageSize", pageSize));
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Tenants> localVarResponse = await ListAccountTenantsWithHttpInfoAsync(id, name, fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenants)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Tenants>> ListAccountTenantsWithHttpInfoAsync(string id, string? name = default(string?), string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Accounts> localVarResponse = ListAccountsWithHttpInfo(fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Accounts</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Accounts> ListAccountsWithHttpInfo(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            Agile.Now.ApiAccounts.Client.RequestOptions localVarRequestOptions = new Agile.Now.ApiAccounts.Client.RequestOptions();
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Accounts> localVarResponse = await ListAccountsWithHttpInfoAsync(fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Accounts)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Accounts>> ListAccountsWithHttpInfoAsync(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = UpdateAccountWithHttpInfo(id, accountData, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Account> UpdateAccountWithHttpInfo(string id, AccountData accountData, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->UpdateAccount");
            }

            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'accountData' when calling AccountsApi->UpdateAccount");
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = await UpdateAccountWithHttpInfoAsync(id, accountData, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Account>> UpdateAccountWithHttpInfoAsync(string id, AccountData accountData, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = UpsertAccountWithHttpInfo(accountData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Account</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Account> UpsertAccountWithHttpInfo(AccountData accountData, int operationIndex = 0)
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'accountData' when calling AccountsApi->UpsertAccount");
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Account> localVarResponse = await UpsertAccountWithHttpInfoAsync(accountData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiAccounts.Client.ApiResponse<Account>> UpsertAccountWithHttpInfoAsync(AccountData accountData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountData' is set
            if (accountData == null)
            {
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Picture> localVarResponse = UpsertAccountPictureWithHttpInfo(id, pictureData, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Picture</returns>
        public Agile.Now.ApiAccounts.Client.ApiResponse<Picture> UpsertAccountPictureWithHttpInfo(string id, PictureData pictureData, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'id' when calling AccountsApi->UpsertAccountPicture");
            }

            // verify the required parameter 'pictureData' is set
            if (pictureData == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'pictureData' when calling AccountsApi->UpsertAccountPicture");
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Picture> localVarResponse = await UpsertAccountPictureWithHttpInfoAsync(id, pictureData, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public Agile.Now.ApiAccounts.Client.ApiResponse<Tenant2> UpsertAccountTenantWithHttpInfo(string id, TenantData tenantData, string? name = default(string?), int operationIndex = 0)
        {
            ...
            if (tenantData == null)
            {
                throw new Agile.Now.ApiAccounts.Client.ApiException(400, "Missing required parameter 'tenantData' when calling AccountsApi->UpsertAccountTenant");
            }
        ...
        {
            Agile.Now.ApiAccounts.Client.ApiResponse<Tenant> localVarResponse = await UpsertAccountTenantWithHttpInfoAsync(id, tenantData, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
