...
namespace Agile.Now.AccessHub.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Meta1")]
    public partial class Meta1 : IValidatableObject
    {
        /// <summary>
        ...
        public Meta1(int totalItems = 0, int currentPage = 1, int pageSize = 50, string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Meta1 and cannot be null");
            }
            this.Type = type;
        }
