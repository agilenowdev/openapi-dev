...
namespace Agile.Now.AccessHub.Model
{
    ...
    public partial class DepartmentText : IValidatableObject
    {
        ...
        /// <param name="parentDepartmentId">The identifier of the parent department.</param>
        ...
        /// <param name="ownerId">The identifier of the user who own the department.</param>
        ...
        public DepartmentText(string id = default(string), string externalId = default(string), string name = default(string), string departmentTypeId = default(string), string parentDepartmentId = default(string), string hierarchicalName = default(string), int level = 0, string contactName = default(string), string contactEmail = default(string), string contactPhone = default(string), string ownerId = default(string), string countryId = default(string), bool isActive = false, DateTime modifiedOn = default(DateTime), string modifiedBy = default(string), string createdBy = default(string), DateTime createdOn = default(DateTime))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DepartmentText and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DepartmentText and cannot be null");
            }
            this.Name = name;
            // to ensure "departmentTypeId" is required (not null)
            if (departmentTypeId == null)
            {
                throw new ArgumentNullException("departmentTypeId is a required property for DepartmentText and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The identifier of the parent department</value>
        ...
        /// </summary>
        /// <value>The identifier of the user who own the department</value>
