...
namespace Agile.Now.AccessHub.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Meta2")]
    public partial class Meta2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Meta2" /> class.
        /// </summary>
        ...
        public Meta2(int totalItems = 0, int currentPage = 1, int pageSize = 50, string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Meta2 and cannot be null");
            }
            this.Type = type;
        }
