...
namespace AccessHub.Api
{
    ...
    public partial class EntitiesApi : IEntitiesApi
    {
        ...
        /// <returns></returns>
        public EntitiesApi(AccessHub.Client.Configuration configuration)
        {
        ...
        public EntitiesApi(AccessHub.Client.ISynchronousClient client, AccessHub.Client.IAsynchronousClient asyncClient, AccessHub.Client.IReadableConfiguration configuration)
        {
        ...
        {
            AccessHub.Client.ApiResponse<Entity> localVarResponse = GetEntityWithHttpInfo(id, name);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Entity</returns>
        public AccessHub.Client.ApiResponse<Entity> GetEntityWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new AccessHub.Client.ApiException(400, "Missing required parameter 'id' when calling EntitiesApi->GetEntity");
            }
        ...
        {
            AccessHub.Client.ApiResponse<Entity> localVarResponse = await GetEntityWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Entity)</returns>
        public async System.Threading.Tasks.Task<AccessHub.Client.ApiResponse<Entity>> GetEntityWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            AccessHub.Client.ApiResponse<Entities> localVarResponse = ListEntitiesWithHttpInfo(fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Entities</returns>
        public AccessHub.Client.ApiResponse<Entities> ListEntitiesWithHttpInfo(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            AccessHub.Client.RequestOptions localVarRequestOptions = new AccessHub.Client.RequestOptions();
        ...
        {
            AccessHub.Client.ApiResponse<Entities> localVarResponse = await ListEntitiesWithHttpInfoAsync(fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Entities)</returns>
        public async System.Threading.Tasks.Task<AccessHub.Client.ApiResponse<Entities>> ListEntitiesWithHttpInfoAsync(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
