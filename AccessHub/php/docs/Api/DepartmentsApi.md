...
```php
createDepartment($department_insert_data): \OpenAPI\Client\Model\Department
```
...
$department_insert_data = new \OpenAPI\Client\Model\DepartmentInsertData(); // \OpenAPI\Client\Model\DepartmentInsertData | `Department` information to insert.  The input parameter must be used in the `DepartmentInsertData` record structure inside the `FieldType` parameter in the foreign key fields.

try {
    $result = $apiInstance->createDepartment($department_insert_data);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DepartmentsApi->createDepartment: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **department_insert_data** | [**\OpenAPI\Client\Model\DepartmentInsertData**](../Model/DepartmentInsertData.md)| &#x60;Department&#x60; information to insert.  The input parameter must be used in the &#x60;DepartmentInsertData&#x60; record structure inside the &#x60;FieldType&#x60; parameter in the foreign key fields. | |

### Return type

[**\OpenAPI\Client\Model\Department**](../Model/Department.md)
...
```php
deleteDepartment($id, $name): \OpenAPI\Client\Model\Department
```
...
$id = 'id_example'; // string | The identifier of the Department record. The parameter is part of the url address and some special characters are forbidden.  You can extract any string to a base64 string. E.g email address name@domain.com value is base64|bmFtZUBkb21haW4uY29t
$name = 'name_example'; // string | The name of the database field. If empty, the entity `Id` field is used.  Example:  ``` Name, ExternalId ```

try {
    $result = $apiInstance->deleteDepartment($id, $name);
    print_r($result);
} catch (Exception $e) {
...
```php
deleteDepartmentUser($id, $sub_id, $name, $sub_name): \OpenAPI\Client\Model\User
```
...
try {
    $result = $apiInstance->deleteDepartmentUser($id, $sub_id, $name, $sub_name);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DepartmentsApi->deleteDepartmentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getDepartment($id, $name): \OpenAPI\Client\Model\Department
```
...
try {
    $result = $apiInstance->getDepartment($id, $name);
    print_r($result);
} catch (Exception $e) {
...
```php
listDepartmentUsers($id, $name, $fields, $filters, $orders, $current_page, $page_size): \OpenAPI\Client\Model\Users
```
...
try {
    $result = $apiInstance->listDepartmentUsers($id, $name, $fields, $filters, $orders, $current_page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DepartmentsApi->listDepartmentUsers: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listDepartments($fields, $filters, $orders, $current_page, $page_size): \OpenAPI\Client\Model\Departments
```
...
try {
    $result = $apiInstance->listDepartments($fields, $filters, $orders, $current_page, $page_size);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\Departments**](../Model/Departments.md)
...
```php
patchDepartmentUsers($id, $users_data, $name, $delete_not_exists): \OpenAPI\Client\Model\User
```
...
try {
    $result = $apiInstance->patchDepartmentUsers($id, $users_data, $name, $delete_not_exists);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DepartmentsApi->patchDepartmentUsers: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
patchDepartments($departments_data): \OpenAPI\Client\Model\Departments
```
...
$departments_data = new \OpenAPI\Client\Model\DepartmentsData(); // \OpenAPI\Client\Model\DepartmentsData | The list of Department information to insert or update.  The input parameter must be used in the `Extra` record array structure inside the `Name` and `FieldName` parameters in the foreign key fields.

try {
    $result = $apiInstance->patchDepartments($departments_data);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DepartmentsApi->patchDepartments: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **departments_data** | [**\OpenAPI\Client\Model\DepartmentsData**](../Model/DepartmentsData.md)| The list of Department information to insert or update.  The input parameter must be used in the &#x60;Extra&#x60; record array structure inside the &#x60;Name&#x60; and &#x60;FieldName&#x60; parameters in the foreign key fields. | |
...
```php
updateDepartment($id, $department_update_data, $name): \OpenAPI\Client\Model\Department
```
...
$id = 'id_example'; // string | The identifier of the Department record. The parameter is part of the url address and some special characters are forbidden.  You can extract any string to a base64 string. E.g email address name@domain.com value is base64|bmFtZUBkb21haW4uY29t
$department_update_data = new \OpenAPI\Client\Model\DepartmentUpdateData(); // \OpenAPI\Client\Model\DepartmentUpdateData | Department information to update.  The input parameter must be used in the `DepartmentUpdateData` record structure inside the `FieldType` parameter in the foreign key fields.
$name = 'name_example'; // string | The name of the database field. If empty, the entity `Id` field is used.  Example:  ``` Name, ExternalId ```

try {
    $result = $apiInstance->updateDepartment($id, $department_update_data, $name);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| The identifier of the Department record. The parameter is part of the url address and some special characters are forbidden.  You can extract any string to a base64 string. E.g email address name@domain.com value is base64|bmFtZUBkb21haW4uY29t | |
| **department_update_data** | [**\OpenAPI\Client\Model\DepartmentUpdateData**](../Model/DepartmentUpdateData.md)| Department information to update.  The input parameter must be used in the &#x60;DepartmentUpdateData&#x60; record structure inside the &#x60;FieldType&#x60; parameter in the foreign key fields. | |
| **name** | **string**| The name of the database field. If empty, the entity &#x60;Id&#x60; field is used.  Example:  &#x60;&#x60;&#x60; Name, ExternalId &#x60;&#x60;&#x60; | [optional] |
...
```php
upsertDepartment($department_upsert_data): \OpenAPI\Client\Model\Department
```
...
$department_upsert_data = new \OpenAPI\Client\Model\DepartmentUpsertData(); // \OpenAPI\Client\Model\DepartmentUpsertData | `Department` information to insert or update.  The input parameter must be used in the `DepartmentUpsertData` record structure inside the `FieldType` parameter in the foreign key fields.

try {
    $result = $apiInstance->upsertDepartment($department_upsert_data);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DepartmentsApi->upsertDepartment: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **department_upsert_data** | [**\OpenAPI\Client\Model\DepartmentUpsertData**](../Model/DepartmentUpsertData.md)| &#x60;Department&#x60; information to insert or update.  The input parameter must be used in the &#x60;DepartmentUpsertData&#x60; record structure inside the &#x60;FieldType&#x60; parameter in the foreign key fields. | |
...
```php
upsertDepartmentUser($id, $user_data, $name): \OpenAPI\Client\Model\User
```
...
try {
    $result = $apiInstance->upsertDepartmentUser($id, $user_data, $name);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DepartmentsApi->upsertDepartmentUser: ', $e->getMessage(), PHP_EOL;
}
```
