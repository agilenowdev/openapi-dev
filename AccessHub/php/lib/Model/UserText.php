 ...
 */
class UserText implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserText';
    ...
    */
     ...
     * Sets user_id
     *
     * @param string|null $user_id The identifier of the user who has link the department
     *
     * @return self
     */
