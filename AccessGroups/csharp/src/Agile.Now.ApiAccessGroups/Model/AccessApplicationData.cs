...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessApplicationData")]
    public partial class AccessApplicationData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessApplicationData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccessApplicationData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessApplicationData" /> class.
        /// </summary>
        ...
        public AccessApplicationData(string id = default(string), FieldType parentApplicationId = default(FieldType), FieldType accessApplicationId = default(FieldType), bool isActive = false, DateTime createdOn = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("accessApplicationId is a required property for AccessApplicationData and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccessApplicationData {\n");
