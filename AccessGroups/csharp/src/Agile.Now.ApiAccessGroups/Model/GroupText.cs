...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class GroupText : IValidatableObject
    {
        ...
        public GroupText(long id = 0, string groupId = default(string), DateTime createdOn = default(DateTime))
        {
            // to ensure "groupId" is required (not null)
            if (groupId == null)
            {
                throw new ArgumentNullException("groupId is a required property for GroupText and cannot be null");
            }
