...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class GroupText : IValidatableObject
    {
        ...
        public GroupText(int id = 0, string name = default(string), string description = default(string), string createdBy = default(string), DateTime created = default(DateTime), bool hasCustomManagement = false)
        {
            this.Id = id;
            this.Name = name;
