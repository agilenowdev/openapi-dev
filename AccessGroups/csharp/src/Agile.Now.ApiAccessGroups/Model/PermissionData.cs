...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class PermissionData : IValidatableObject
    {
        ...
        public PermissionData(long id = 0, FieldType accessRoleId = default(FieldType), FieldType roleId = default(FieldType), EnumPermissionType permissionId = default(EnumPermissionType), bool isActive = false, DateTime createdOn = default(DateTime))
        {
