...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class UserExternal : IValidatableObject
    {
        ...
        public UserExternal(int id = 0, AbstractLong userId = default(AbstractLong))
        {
            this.Id = id;
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for UserExternal and cannot be null");
            }
            this.UserId = userId;
        }
