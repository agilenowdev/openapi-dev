...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class GroupExternalsData : IValidatableObject
    {
        ...
        public GroupExternalsData(List<ListValidation> extra = default(List<ListValidation>), bool isFullValidation = false, List<GroupExternalText> groupExternals = default(List<GroupExternalText>))
        {
            this.Extra = extra;
            this.IsFullValidation = isFullValidation;
            this.GroupExternals = groupExternals;
        }
