...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class UserExternalsData : IValidatableObject
    {
        ...
        public UserExternalsData(List<ListValidation> extra = default(List<ListValidation>), bool isFullValidation = false, List<UserExternalText> userExternals = default(List<UserExternalText>))
        {
            this.Extra = extra;
            this.IsFullValidation = isFullValidation;
            this.UserExternals = userExternals;
        }
