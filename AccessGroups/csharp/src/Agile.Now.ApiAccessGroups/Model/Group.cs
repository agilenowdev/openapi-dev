...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class Group : IValidatableObject
    {
        ...
        public Group(int id = 0, string name = default(string), string description = default(string), AbstractLong createdBy = default(AbstractLong), DateTime created = default(DateTime), bool hasCustomManagement = false)
        {
            this.Id = id;
            this.Name = name;
