...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class PermissionsData : IValidatableObject
    {
        ...
        public PermissionsData(List<ListValidation> extra = default(List<ListValidation>), bool isFullValidation = false, List<PermissionText> permissions = default(List<PermissionText>))
        {
            this.Extra = extra;
