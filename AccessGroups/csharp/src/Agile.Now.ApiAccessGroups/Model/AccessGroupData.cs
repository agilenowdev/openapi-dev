...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class AccessGroupData : IValidatableObject
    {
        ...
        public AccessGroupData(string id = default(string), string name = default(string), string externalId = default(string), string description = default(string), bool isActive = false, bool isSystem = false, EnumAccessGroupType? accessGroupTypeId = default(EnumAccessGroupType?), DateTime modifiedOn = default(DateTime), FieldType modifiedBy = default(FieldType), FieldType createdBy = default(FieldType), DateTime createdOn = default(DateTime))
        {
