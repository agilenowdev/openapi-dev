...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class UserExternalData : IValidatableObject
    {
        ...
        public UserExternalData(int id = 0, FieldType userId = default(FieldType))
        {
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for UserExternalData and cannot be null");
            }
            this.UserId = userId;
            this.Id = id;
        }
