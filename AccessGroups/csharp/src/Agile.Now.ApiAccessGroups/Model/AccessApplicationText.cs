...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessApplicationText")]
    public partial class AccessApplicationText : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessApplicationText" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccessApplicationText() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessApplicationText" /> class.
        /// </summary>
        ...
        public AccessApplicationText(string id = default(string), string parentApplicationId = default(string), string accessApplicationId = default(string), bool isActive = false, DateTime createdOn = default(DateTime))
        {
            // to ensure "parentApplicationId" is required (not null)
            if (parentApplicationId == null)
            {
                throw new ArgumentNullException("parentApplicationId is a required property for AccessApplicationText and cannot be null");
            }
            this.ParentApplicationId = parentApplicationId;
            // to ensure "accessApplicationId" is required (not null)
            if (accessApplicationId == null)
            {
                throw new ArgumentNullException("accessApplicationId is a required property for AccessApplicationText and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccessApplicationText {\n");
