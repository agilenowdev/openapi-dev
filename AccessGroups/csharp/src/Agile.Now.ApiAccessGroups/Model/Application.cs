...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class Application : IValidatableObject
    {
        ...
        public Application(string id = default(string), AbstractText parentApplicationId = default(AbstractText), AbstractText accessApplicationId = default(AbstractText), bool isActive = false, DateTime createdOn = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("parentApplicationId is a required property for Application and cannot be null");
            }
            this.ParentApplicationId = parentApplicationId;
            // to ensure "accessApplicationId" is required (not null)
            if (accessApplicationId == null)
            {
                throw new ArgumentNullException("accessApplicationId is a required property for Application and cannot be null");
            }
