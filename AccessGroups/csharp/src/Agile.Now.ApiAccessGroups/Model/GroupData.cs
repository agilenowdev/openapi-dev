...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class GroupData : IValidatableObject
    {
        ...
        public GroupData(int id = 0, string name = default(string), string description = default(string), FieldType createdBy = default(FieldType), DateTime created = default(DateTime), bool hasCustomManagement = false)
        {
            this.Id = id;
            this.Name = name;
