...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class PermissionText : IValidatableObject
    {
        ...
        public PermissionText(long id = 0, string accessRoleId = default(string), string roleId = default(string), string permissionId = default(string), bool isActive = false, DateTime createdOn = default(DateTime))
        {
            // to ensure "permissionId" is required (not null)
            if (permissionId == null)
            {
                throw new ArgumentNullException("permissionId is a required property for PermissionText and cannot be null");
            }
