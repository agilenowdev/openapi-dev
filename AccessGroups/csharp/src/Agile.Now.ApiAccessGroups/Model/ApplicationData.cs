...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class ApplicationData : IValidatableObject
    {
        ...
        public ApplicationData(string id = default(string), FieldType parentApplicationId = default(FieldType), FieldType accessApplicationId = default(FieldType), bool isActive = false, DateTime createdOn = default(DateTime))
        {
            // to ensure "parentApplicationId" is required (not null)
            if (parentApplicationId == null)
            {
                throw new ArgumentNullException("parentApplicationId is a required property for ApplicationData and cannot be null");
            }
            this.ParentApplicationId = parentApplicationId;
            // to ensure "accessApplicationId" is required (not null)
            if (accessApplicationId == null)
            {
                throw new ArgumentNullException("accessApplicationId is a required property for ApplicationData and cannot be null");
            }
