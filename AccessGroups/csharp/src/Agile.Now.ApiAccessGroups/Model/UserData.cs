...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    public partial class UserData : IValidatableObject
    {
        ...
        public UserData(long id = 0, FieldType userId = default(FieldType), DateTime createdOn = default(DateTime))
        {
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for UserData and cannot be null");
            }
            this.UserId = userId;
