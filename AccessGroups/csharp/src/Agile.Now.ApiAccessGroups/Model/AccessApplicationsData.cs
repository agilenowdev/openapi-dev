...
namespace Agile.Now.ApiAccessGroups.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessApplicationsData")]
    public partial class AccessApplicationsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessApplicationsData" /> class.
        /// </summary>
        ...
        /// <param name="accessApplications">The list of &#x60;AccessApplication&#x60; data record for import.</param>
        public AccessApplicationsData(List<ListValidation> extra = default(List<ListValidation>), bool isFullValidation = false, List<AccessApplicationText> accessApplications = default(List<AccessApplicationText>))
        {
            this.Extra = extra;
        ...
        /// <summary>
        /// The list of &#x60;AccessApplication&#x60; data record for import
        /// </summary>
        /// <value>The list of &#x60;AccessApplication&#x60; data record for import</value>
        [DataMember(Name = "AccessApplications", EmitDefaultValue = false)]
        public List<AccessApplicationText> AccessApplications { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccessApplicationsData {\n");
            sb.Append("  Extra: ").Append(Extra).Append("\n");
            sb.Append("  IsFullValidation: ").Append(IsFullValidation).Append("\n");
            sb.Append("  AccessApplications: ").Append(AccessApplications).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
