...
public class ApiClient {
    ...
    private String basePath = "https://dev.esystems.fi";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://dev.esystems.fi",
      "Default entry point of service Agile.Now server",
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://dev.esystems.fi/oAuth/rest/v2/Token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dev.esystems.fi
