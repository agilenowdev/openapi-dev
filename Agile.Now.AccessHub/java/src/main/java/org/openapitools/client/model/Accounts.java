...
public class Accounts {
  ...
  public Accounts meta(Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public Accounts data(List<Account> data) {
    this.data = data;
    return this;
  }

  public Accounts addDataItem(Account dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, accounts.meta) &&
        Objects.equals(this.data, accounts.data);
  }
