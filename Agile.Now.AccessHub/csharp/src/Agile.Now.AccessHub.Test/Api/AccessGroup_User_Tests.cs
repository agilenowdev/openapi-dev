...
public class AccessGroup_User_Tests
    : SubEntityTests<AccessGroup, string, AccessGroupData, User, int, UserData>
{
    ...
    public AccessGroup_User_Tests()
        : base(
            ...
            testData: new AccessGroup_User_TestData(),
    ...
    protected override User[] Patch(string id, List<UserData> data, string deleteNotExists) =>
        api.PatchAccessGroupUsers(id: id,
            usersData: new(users: data.Select(i => i.ToUserText()).ToList()),
