...
public class AccessGroup_Tests : EntityTests<AccessGroup, string, AccessGroupData>
{
    ...
    protected override AccessGroup Update(string id, AccessGroupData data, string name) =>
        api.UpdateAccessGroup(id, data, name);
