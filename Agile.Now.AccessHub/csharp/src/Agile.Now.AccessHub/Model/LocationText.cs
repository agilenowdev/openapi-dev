...
namespace Agile.Now.AccessHub.Model
{
    ...
    public partial class LocationText : IValidatableObject
    {
        ...
        /// <param name="countryId">The country of the location.</param>
        ...
        public LocationText(string id = default(string), string externalId = default(string), string name = default(string), string countryId = default(string), string timezoneId = default(string), string currencyId = default(string), bool isActive = false, DateTime modifiedOn = default(DateTime), string modifiedBy = default(string), string createdBy = default(string), DateTime createdOn = default(DateTime))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for LocationText and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for LocationText and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>The timezone of the location</value>
        ...
        /// </summary>
        /// <value>The currency of the location</value>
