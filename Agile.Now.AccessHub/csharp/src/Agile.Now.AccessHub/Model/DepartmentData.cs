...
namespace Agile.Now.AccessHub.Model
{
    ...
    public partial class DepartmentData : IValidatableObject
    {
        ...
        public DepartmentData(string id = default, string externalId = default, string name = default, DepartmentTypeIdEnum departmentTypeId = default, FieldType parentDepartmentId = default, string contactName = default, string contactEmail = default, string contactPhone = default, FieldType ownerId = default, CountryIdEnum? countryId = default, bool isActive = false)
        {
