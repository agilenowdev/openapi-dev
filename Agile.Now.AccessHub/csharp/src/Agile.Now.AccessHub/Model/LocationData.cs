...
namespace Agile.Now.AccessHub.Model
{
    ...
    public partial class LocationData : IValidatableObject
    {
        ...
        public LocationData(string id = default(string), string externalId = default(string), string name = default(string), CountryIdEnum? countryId = default(CountryIdEnum?), TimezoneIdEnum? timezoneId = default(TimezoneIdEnum?), CurrencyIdEnum? currencyId = default(CurrencyIdEnum?), bool isActive = false)
        {
