...
namespace Agile.Now.AccessHub.Model
{
    ...
    public partial class LocationUpdateData : IValidatableObject
    {
        ...
        public LocationUpdateData(string externalId = default(string), string name = default(string), CountryIdEnum? countryId = default(CountryIdEnum?), TimezoneIdEnum? timezoneId = default(TimezoneIdEnum?), CurrencyIdEnum? currencyId = default(CurrencyIdEnum?), bool isActive = false)
        {
