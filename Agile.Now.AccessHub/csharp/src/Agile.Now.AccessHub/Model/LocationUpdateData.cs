...
namespace Agile.Now.AccessHub.Model
{
    ...
    public partial class LocationUpdateData : IValidatableObject
    {
        ...
        public LocationUpdateData(string externalId = default, string name = default, CountryIdEnum? countryId = default, TimezoneIdEnum? timezoneId = default, CurrencyIdEnum? currencyId = default, bool isActive = false)
        {
