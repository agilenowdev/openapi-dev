...
namespace Agile.Now.AccessHub.Api
{
    ...
    public partial class DepartmentsApi : IDepartmentsApi
    {
        ...
        {
            Agile.Now.AccessHub.Client.ApiResponse<Department> localVarResponse = UpsertDepartmentWithHttpInfo(departmentData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Department</returns>
        public Agile.Now.AccessHub.Client.ApiResponse<Department> UpsertDepartmentWithHttpInfo(DepartmentData departmentData, int operationIndex = 0)
        {
            // verify the required parameter 'departmentData' is set
            if (departmentData == null)
            {
                throw new Agile.Now.AccessHub.Client.ApiException(400, "Missing required parameter 'departmentData' when calling DepartmentsApi->UpsertDepartment");
            }
        ...
        {
            Agile.Now.AccessHub.Client.ApiResponse<Department> localVarResponse = await UpsertDepartmentWithHttpInfoAsync(departmentData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Department)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.AccessHub.Client.ApiResponse<Department>> UpsertDepartmentWithHttpInfoAsync(DepartmentData departmentData, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'departmentData' is set
            if (departmentData == null)
            {
