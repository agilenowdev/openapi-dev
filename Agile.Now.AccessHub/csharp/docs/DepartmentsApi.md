...
> User1 DeleteDepartmentUser (string id, string subId, string name = null, string subName = null)
...
namespace Example
{
    public class DeleteDepartmentUserExample
    {
        public static void Main()
        {
            ...
            try
            {
                User1 result = apiInstance.DeleteDepartmentUser(id, subId, name, subName);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<User1> response = apiInstance.DeleteDepartmentUserWithHttpInfo(id, subId, name, subName);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **ListDepartmentUsers**
> Users1 ListDepartmentUsers (string id, string name = null, string fields = null, string filters = null, string orders = null, int? currentPage = null, int? pageSize = null)
...
namespace Example
{
    public class ListDepartmentUsersExample
    {
        public static void Main()
        {
            ...
            try
            {
                Users1 result = apiInstance.ListDepartmentUsers(id, name, fields, filters, orders, currentPage, pageSize);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<Users1> response = apiInstance.ListDepartmentUsersWithHttpInfo(id, name, fields, filters, orders, currentPage, pageSize);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> User1 UpsertDepartmentUser (string id, UserData1 userData1, string name = null)
...
namespace Example
{
    public class UpsertDepartmentUserExample
    {
        public static void Main()
        {
            ...
            try
            {
                User1 result = apiInstance.UpsertDepartmentUser(id, userData1, name);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<User1> response = apiInstance.UpsertDepartmentUserWithHttpInfo(id, userData1, name);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
