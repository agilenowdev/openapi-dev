...
<a name="list Locations"></a>
# **list Locations**
> Locations list Locations(Fields, Filters, Orders, CurrentPage, PageSize)
...
<a name="patch Location Users"></a>
# **patch Location Users**
> User patch Location Users(Id, UsersData, Name, DeleteNotExists)
