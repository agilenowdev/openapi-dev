...
namespace Agile.Now.ApiWebhooks.Api
{
    ...
    public partial class EntitiesApi : IEntitiesApi
    {
        ...
        /// <returns></returns>
        public EntitiesApi(Agile.Now.ApiWebhooks.Client.Configuration configuration)
        {
        ...
        public EntitiesApi(Agile.Now.ApiWebhooks.Client.ISynchronousClient client, Agile.Now.ApiWebhooks.Client.IAsynchronousClient asyncClient, Agile.Now.ApiWebhooks.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Agile.Now.ApiWebhooks.Client.ApiResponse<Entity> localVarResponse = GetEntityWithHttpInfo(id, name);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Entity</returns>
        public Agile.Now.ApiWebhooks.Client.ApiResponse<Entity> GetEntityWithHttpInfo(string id, string? name = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agile.Now.ApiWebhooks.Client.ApiException(400, "Missing required parameter 'id' when calling EntitiesApi->GetEntity");
            }
        ...
        {
            Agile.Now.ApiWebhooks.Client.ApiResponse<Entity> localVarResponse = await GetEntityWithHttpInfoAsync(id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Entity)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiWebhooks.Client.ApiResponse<Entity>> GetEntityWithHttpInfoAsync(string id, string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Agile.Now.ApiWebhooks.Client.ApiResponse<Entities> localVarResponse = ListEntitiesWithHttpInfo(fields, filters, orders, currentPage, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Entities</returns>
        public Agile.Now.ApiWebhooks.Client.ApiResponse<Entities> ListEntitiesWithHttpInfo(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            Agile.Now.ApiWebhooks.Client.RequestOptions localVarRequestOptions = new Agile.Now.ApiWebhooks.Client.RequestOptions();
        ...
        {
            Agile.Now.ApiWebhooks.Client.ApiResponse<Entities> localVarResponse = await ListEntitiesWithHttpInfoAsync(fields, filters, orders, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Entities)</returns>
        public async System.Threading.Tasks.Task<Agile.Now.ApiWebhooks.Client.ApiResponse<Entities>> ListEntitiesWithHttpInfoAsync(string? fields = default(string?), string? filters = default(string?), string? orders = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
